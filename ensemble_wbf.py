...
with open('pred_040.json', 'r') as f:
    preds1 = json.load(f)
with open('pred_ep36.json', 'r') as f:
    preds2 = json.load(f)
...
all_image_ids = set(grouped1.keys()).union(set(grouped2.keys()))
...
iou_thr = 0.60 
skip_box_thr = 0.0001
weights = [1, 1] # Treat both epochs equally
...
for img_id in all_image_ids:
    ...
    for epoch_preds in [grouped1[img_id], grouped2[img_id]]:
...
print("WBF complete! Rename 'pred_wbf.json' to 'pred.json'")